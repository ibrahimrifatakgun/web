...
<body>
    ...
    <ol>
        ...
        <li>Else son kapanış koşuludur. (Herhangi bir şart belirtilmez. Hiçbir ön koşul gerçekleşmediğinde çalışacak son koşulu ifade eder.)</li>
    </ol>
    ...
    echo "sayı: $sayı";
    if($sayı % 2 == 0){
        echo " Girilen sayı çift";
      }
      else{
        echo " Girilen sayı tek";
    }
    ...
    $not = rand(0, 100);
    if ($not >= 50) {
        echo "Geçtiniz-Not: $not";
    } else {
        echo "Kaldınız-Not: $not";
    }
